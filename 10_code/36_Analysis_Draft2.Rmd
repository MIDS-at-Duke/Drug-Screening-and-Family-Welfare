...
last points at the end of the range of the data also fall below the line. This indicates that the data
exhibits left skew. Further analysis may augment the data to explain more variability of the response variable.  
